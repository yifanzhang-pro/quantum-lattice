...
- [10/22/2025] Updated the `docs/QuantumLattice.pdf` ([arxiv v4](https://arxiv.org/abs/2509.12341v4)) with more details, and all assumptions are explicitly listed: [docs/QuantumLattice.pdf](https://yifanzhang-pro.github.io/quantum-lattice/QuantumLattice.pdf).
